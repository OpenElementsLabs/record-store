...
process.env.RECORD_STORE_E2E_EXPECTED_MODE = 'standalone';
...
process.env.RECORD_STORE_E2E_S3_PORT = String(S3_PORT);
...
export default defineConfig({
  ...
  webServer: [
    {
      command: 'node e2e/start-record-store.mjs',
      ...
      stderr: 'pipe',
      env: {
        RECORD_STORE_E2E_S3_PORT: String(S3_PORT),
        RECORD_STORE_E2E_API_PORT: String(API_PORT),
        RECORD_STORE_E2E_CONSOLE_PORT: String(CONSOLE_PORT),
        RECORD_STORE_E2E_RPC_PORT: String(RPC_PORT),
        RECORD_STORE_E2E_HARNESS_PORT: String(HARNESS_PORT),
        RECORD_STORE_E2E_TOKEN: MANAGEMENT_TOKEN,
      },
    },
    {
