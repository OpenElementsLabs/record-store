...
| Archive | Use it when |
| --- | --- |
| `record-store-0.2.1-linux-amd64-musl.tar.gz` | Anywhere. Statically linked, no libc dependency. |
| `record-store-0.2.1-linux-amd64.tar.gz` | You want exactly what is inside the container image. |
