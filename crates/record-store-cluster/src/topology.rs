...
// Storage-class labels moved to the core domain crate, where both a device and
// a bucket can name one. Re-exported so cluster callers keep one import path.
pub use record_store_core::StorageClass;
